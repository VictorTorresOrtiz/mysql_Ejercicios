...
SELECT nombre, (precio/22.09) , (precio/23.32 )  FROM producto;

#5. Lista el nombre de los productos, el precio en euros y el precio en dólares estadounidenses (USD). Utiliza los siguientes alias para las columnas: nombre de producto, euros, dólares.
SELECT nombre AS Nombre_de_Producto, (precio/22.09) AS EURO, (precio/23.32) AS DOLLAR FROM producto;
...
SELECT nombre, substring(nombre,1,2) AS NombresPrimeros FROM fabricante;

#9. Lista los nombres y los precios de todos los productos de la tabla producto, redondeando el valor del precio.
SELECT nombre, ROUND(precio) AS Precios FROM producto;
...
SELECT * FROM producto WHERE codigo_fabricante=1 OR codigo_fabricante=2 OR codigo_fabricante=5;
...
SELECT nombre FROM fabricante WHERE nombre LIKE 'S%'; #EL PORCENTAJE AL FINAL = PRIMERA LETRA
...
SELECT producto.codigo, producto.nombre, fabricante.codigo, fabricante.nombre FROM product INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo;

#4. Devuelve el nombre del producto, su precio y el nombre de su fabricante, del producto más barato.
SELECT producto.codigo, producto.nombre, fabricante.codigo, fabricante.nombre FROM product INNER JOIN fabricante ORDER BY producto.precio ASC ;

#5. Devuelve el nombre del producto, su precio y el nombre de su fabricante, del producto más caro.
SELECT producto.codigo, producto.nombre, fabricante.codigo, fabricante.nombre FROM product INNER JOIN fabricante ORDER BY producto.precio DESC;
...
SELECT * FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo WHERE fabricante.nombre = 'Hewlett-Packardy' OR fabricante.nombre = 'Asus' OR fabricante.nombre = 'Seagate';
...
SELECT producto.nombre, producto.precio, fabricante.nombre FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante_codigo WHERE producto.precio >=180 ORDER BY producto.precio DESC, producto.nombre ASC;
...
SELECT fabricante.codigo, fabricante.nombre FROM fabricante INNER JOIN producto ON fabricante_codigo = producto.codigo_fabricante; 
...
SELECT count(DISTINT codigo_fabricante) from producto;
...
SELECT SUM(producto.precio) FROM fabricante INNER JOIN producto ON fabricante.codigo = producto.codigo_fabricante;

15. Muestra el precio máximo, precio mínimo, precio medio y el número total de productos que tiene el fabricante Crucial.
SELECT MAX(producto.precio) AS MAX, MIN(producto.precio) AS MIN, AVG(producto.precio) AS AVG FROM fabricante INNER JOIN producto ON fabricante.codigo = producto.codigo_fabricante WHERE fabricante.nombre = 'Crucial';
...
SELECT MAX(producto.precio) AS MAX, MIN(producto.precio) AS MIN, AVG(producto.precio) AS AVG FROM fabricante INNER JOIN producto ON producto.codigo_fabricante = fabricante.codigo GROUP BY fabricante.codigo;
...
SELECT codigo_fabricante, MAX(precio) AS MAX, MIN(precio) AS MIN, AVG(precio)AS AVG FROM producto GROUP BY codigo_fabricante HAVING AVG(PRECIO) > 200;

19. Muestra el nombre de cada fabricante, junto con el precio máximo, precio mínimo, precio medio y el  número total de productos de los fabricantes que tienen un precio medio superior a 200€. Es necesario mostrar el nombre del fabricante.
SELECT fabricante.nombre, MAX(producto.precio)AS MAX, MIN(producto.precio)AS MIN, AVG(producto.precio) AS AVG, COUNT(*) FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo GROUP BY fabricante.codigo HAVING AVG(producto.precio) > 200;
